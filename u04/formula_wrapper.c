...
static int32_t check_int_shift(int32_t a, int32_t b, int32_t c, int32_t d,
  ...
  return (((a + b) * (c - d)) * ((e << 3) + (f << 2) - (g >> 1) + (h >> 2))) /
         3;
}
...
int main(int argc, char *argv[]) {
  ...
  int32_t a_int = a, b_int = b, c_int = c, d_int = d, e_int = e, f_int = f,
          g_int = g, h_int = h;
  double res_flt = formula_flt(a, b, c, d, e, f, g, h);
  double chk_flt = check_flt(a, b, c, d, e, f, g, h);
  int32_t res_int =
      formula_int(a_int, b_int, c_int, d_int, e_int, f_int, g_int, h_int);
  int32_t chk_int =
      check_int(a_int, b_int, c_int, d_int, e_int, f_int, g_int, h_int);
  int32_t chk_int_shift =
      check_int_shift(a_int, b_int, c_int, d_int, e_int, f_int, g_int, h_int);
